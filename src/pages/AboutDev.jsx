...
const AboutDev = () => {
    return (
        <><Navbar />
            <div className="min-h-[calc(100vh-264px)] flex flex-col items-center justify-center bg-gray-100 px-6">
                <div className="bg-white p-8 shadow-lg rounded-2xl max-w-2xl text-center">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mt-2">
                            ...
                            <span className="px-3 py-1 bg-red-100 text-gray-600 rounded-full text-sm">Firebase</span>
                        </div>
                    </div>
